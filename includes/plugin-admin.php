	...
	class plugin_admin {	
		...
		function config_page_styles() {
			...
			if ( $pagenow == 'tools.php' && isset( $_GET['page'] ) && in_array( $_GET['page'], $this->adminpages ) ) {
				...
				wp_enqueue_style( 'plugin-admin', plugins_url( 'css/plugin-admin.css', dirname( __FILE__ ) ), array(), al_VERSION );
	
				//if ( is_rtl() )
					//wp_enqueue_style( 'wpplugin-rtl', plugins_url( 'css/wpplugin-rtl.css', dirname( __FILE__ ) ), array(), al_VERSION );
			}
		}
		...
		function config_page_scripts() {
			...
			if ( $pagenow == 'tools.php' && isset( $_GET['page'] ) && in_array( $_GET['page'], $this->adminpages ) ) {
				//wp_enqueue_script( 'wpplugin-admin-script', plugins_url( 'js/plugin-admin.js', dirname( __FILE__ ) ), array( 'jquery' ), al_VERSION, true );
